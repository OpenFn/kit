...
test.serial("loadTransformOptions: describes imports from an explicit path", async (t) => {
  mock({
...
test.serial("loadTransformOptions: describes imports from an explicit path and version specifier", async (t) => {
  mock({
    '/modules/': mock.load(path.resolve('test/__modules__/'), {}),
  })
  const opts = {
...
test.serial("loadTransformOptions: describes imports from a relative path from modulesHome", async (t) => {
  mock({
    '/modules/': mock.load(path.resolve('test/__modules__/'), {}),
  })
  const opts = {
